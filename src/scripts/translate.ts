...
// npm install && npm run translate

import fs from 'fs/promises';
import path from 'path';
import { fileURLToPath } from 'url';
// OpenAI agents removed - translation functionality disabled
...
// OpenAI API key setting removed - functionality disabled
console.warn('Translation functionality has been disabled - OpenAI agents removed');
...
- Convert path in the following rules:
  - Replace /hiaryai-wiki/XXX/* with /hiaryai-wiki/${langCode}/XXX/*
  - When the path starts with /hiaryai-wiki/hiaryai/, don't change anything
  - Don't change the first /hiaryai-wiki/ part in any case
...
// Runner removed - functionality disabled
const runner = null;
...
async function callAgent(
  ...
  throw new Error('Translation functionality has been disabled - OpenAI agents removed');
}
