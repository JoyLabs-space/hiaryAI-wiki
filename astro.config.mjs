      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '학습 대시보드', link: '/features/dashboard/' },
            { label: '글로벌 커뮤니티', link: '/features/community/' },
            { label: '시리즈 관리', link: '/features/series/' },
            { label: 'TILs', link: '/features/tils/' },
            { label: '태그 시스템', link: '/features/tags/' },
            { label: '뱃지 시스템', link: '/features/badges/' },
